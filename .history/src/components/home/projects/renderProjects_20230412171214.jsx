...
export default function renderProjects(data){
    ...
    https://if4health-files.s3.sa-east-1.amazonaws.com/img/projects/denia.jpg%20%20%20%20%20%20%20https://if4health-files.s3.sa-east-1.amazonaws.com/img/students/denia.jpg
    data.forEach((e) => {
        key += 1;
