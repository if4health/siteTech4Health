    ...
    data.forEach((e) => {          
        list.push(
            <>
                ...
                <br/>
                <br/>
                https://if4health-files.s3.sa-east-1.amazonaws.com/pdf/full_55_p-416-423_out_CardIoT%2B-%2BEletrocardi%C3%83%C2%B3grafo%2BInteroper%C3%83%C2%A1vel%2BBaseado%2Bem%2BInternet%2520(1).pdf
