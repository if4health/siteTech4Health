    ...
    return(
        <>
            <div className="col-lg-4 text-center">
                ...
                <p className="text-justify">Doutor em Ciência da Computação (PUCRS-2018). Professor de Programação. Iniciando pesquisas com gerenciamento de recursos para HealthCare e IoT para HealthCare.</p>
                <p>
